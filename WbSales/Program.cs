        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    var sllepTime = TimeSpan.FromMinutes(30);
                    _page = 1;
                    Console.WriteLine($"Sleep to {sllepTime}");
        ...
        private static void LoadJson()
        {
            ...
            while (requestSuccess)
            {
                ...
                if (string.IsNullOrEmpty(response))
                {
                    ...
                    Console.WriteLine($"Start get page {_page} ended or failed\n");
                }
                else
                {
                    Console.WriteLine($"Start get page {_page} success\n");
